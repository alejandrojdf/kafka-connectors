...
# connect-standalone command to create a standalone connector
# worker.properties file with the configuration for the worker
# file-stream-demo-standalone.properties file with the configuration of the connector.
